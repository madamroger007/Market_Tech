...
export default function Nav({show}) {
  ...
  const activeLink =
    inactiveLink + " bg-highlight text-primary font-bold rounded-sm";
 ...
 async function logout(){
  ...
  return (
    <aside className={(show ? 'left-0':'-left-full' )+" top-0 bg-bgGray text-gray-600 p-4 fixed w-full h-full md:static md:w-auto transition-all"}>
